...
The **number** following the letter (e.g., the '7' in $H7$) represents the **International Tolerance Grade (IT)**. This represents the magnitude of the tolerance zone. Mathematically, as the IT grade increases, the manufacturing window widens, meaning a looser requirement for precision.

Please see a description of the preferred metric fits below. Select from those if possible. 

```{r, echo=FALSE, out.width="75%", fig.align="center", fig.cap="[Preferred Sizes (metric)](images/DescriptionPreferredMetric.png)"}
knitr::include_graphics("images/DescriptionPreferredMetric.png")
```

### Metric Hole Basis Fits {#metric-fits-hole}
...
### Metric Shaft Basis Fits {#metric-fits-shaft}
